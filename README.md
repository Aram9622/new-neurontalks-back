...
Delivery is idempotent for each subscriber and month. Re-running the same month
skips successfully delivered emails and retries only deliveries that previously
failed.
